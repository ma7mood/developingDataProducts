...
* The project is hosted on shiny apps at the following link: https://ma7mood.shinyapps.io/my-app/
* The source code of the app is published on github at the following link: https://github.com/ma7mood/developingDataProducts/tree/master/my-app
